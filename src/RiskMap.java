...
public class RiskMap {
    static private final Image MAP_IMAGE = Toolkit.getDefaultToolkit().getImage("./images/map.jpg");
    static private final Image VICTORY_IMAGE = Toolkit.getDefaultToolkit().getImage("./images/victory.jpg");
    ...
    static public void draw(Risk frame, int mouseX, int mouseY, Gameplay.Phase phase) throws FontFormatException, IOException {
        ...
        Button.drawPhaseClickButton(frame, 719, 830, mouseX, mouseY);
        // Draws current phase
